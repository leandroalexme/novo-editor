...
// Remove background section if it exists
const filteredSections = DEFAULT_SECTIONS.filter(section => section.name !== 'background');
DEFAULT_SECTIONS.length = 0;
DEFAULT_SECTIONS.push(...filteredSections);
